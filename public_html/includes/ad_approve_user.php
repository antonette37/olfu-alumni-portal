...
require_once __DIR__ . '/includes/ad_approve_workflow.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['user_id']) && isset($_POST['action'])) {
    ...
    try {
        ...
        ad_approve_process_user($conn, $user_id, $action, $reason, $email_function_available, $phpmailer_available);
        /* ad_approve_process_user exits */
    } catch (Throwable $e) {
